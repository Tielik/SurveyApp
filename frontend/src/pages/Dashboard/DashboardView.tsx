...
import type { Survey } from "./DashboardAction"
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-lg flex flex-col md:flex-row justify-between items-center border border-white/20">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Tworz ankiety i sledz wyniki na zywo</p>
          </div>
                    ...
                    >
                      <span
                        className={`w-2 h-2 rounded-full ${
                          survey.is_active ? "bg-green-500 animate-pulse" : "bg-gray-400"
                        }`}
                      ></span>
